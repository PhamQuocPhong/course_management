...
const CourseJoin = require('../models/course_join')
...
User.hasMany(CourseJoin, {onDelete: 'cascade', hooks:true})
CourseJoin.belongsTo(User, {onDelete: 'cascade', hooks:true})
Course.hasMany(CourseJoin, {onDelete: 'cascade', hooks:true})
CourseJoin.belongsTo(Course, {onDelete: 'cascade', hooks:true})
